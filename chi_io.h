 ...
 * @return A chi_errno_t indicating success or failure.
 */
CHI_API chi_errno_t chi_read_n(chi_string* chi_str, FILE* file, int n);
 ...
 * @return A chi_errno_t indicating success or failure.
 */
CHI_API chi_errno_t chi_read(chi_string* chi_str, FILE* file);
 ...
 * @return A chi_errno_t indicating success or failure.
 */
CHI_API chi_errno_t chi_read_from_filepath(chi_string* chi_str, const char* filepath);
 ...
 * @return A chi_errno_t indicating success or failure.
 */
CHI_API chi_errno_t chi_read_to_end_n(chi_string* chi_str, FILE* file, int n);
 ...
 * @return A chi_errno_t indicating success or failure.
 */
CHI_API chi_errno_t chi_read_to_end(chi_string* chi_str, FILE* file);
 ...
 * @return A chi_errno_t indicating success or failure.
 */
CHI_API chi_errno_t chi_write(const chi_string* chi_str, FILE* file);
 ...
 * @return A chi_errno_t indicating success or failure.
 */
CHI_API chi_errno_t chi_write_fp(const chi_string* chi_str, const char* filepath);
 ...
 * @return A chi_errno_t indicating success or failure.
 */
CHI_API chi_errno_t chi_scan_n(chi_string* chi_str, int n);
 ...
 * @return A chi_errno_t indicating success or failure.
 */
CHI_API chi_errno_t chi_scan(chi_string* chi_str);
 ...
 * @return A chi_errno_t indicating success or failure.
 */
CHI_API chi_errno_t chi_scan_to_end_n(chi_string* chi_str, int n);
 ...
 * @return A chi_errno_t indicating success or failure.
 */
CHI_API chi_errno_t chi_scan_to_end(chi_string* chi_str);
 ...
 * @return A chi_errno_t indicating success or failure.
 */
CHI_API chi_errno_t chi_print(const chi_string* chi_str);
 ...
 * @return A chi_errno_t indicating success or failure.
 */
CHI_API chi_errno_t chi_println(const chi_string* chi_str);
 ...
 * @return A chi_errno_t indicating success or failure.
 */
CHI_API chi_errno_t chi_sv_writef(chi_string_view sv, FILE* file);
 ...
 * @return A chi_errno_t indicating success or failure.
 */
CHI_API chi_errno_t chi_sv_writefp(chi_string_view sv, const char* filepath);
 ...
 * @return A chi_errno_t indicating success or failure.
 */
CHI_API chi_errno_t chi_sv_print(chi_string_view sv);
 ...
 * @return A chi_errno_t indicating success or failure.
 */
CHI_API chi_errno_t chi_sv_println(chi_string_view sv);
